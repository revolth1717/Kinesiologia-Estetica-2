          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div>
                <div className="flex items-stretch">
                  <span
                    className={`inline-flex items-center px-3 border border-r-0 rounded-l-md bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 ${
                      fieldErrors.nombre
                  ...
                  <input
                    ...
                    className={`w-full pl-5 pr-4 h-12 border rounded-r-md rounded-l-none focus:ring-2 focus:ring-pink-500 focus:border-transparent ${
                      fieldErrors.nombre
                        ? "border-red-300 bg-red-50 dark:bg-gray-800 dark:border-red-700 dark:text-gray-100"
                        : "border-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100"
                    }`}
            ...
            <div>
              ...
              <div>
                <div className="flex items-stretch">
                  <span
                    className={`inline-flex items-center px-3 h-12 border border-r-0 rounded-l-md bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 ${
                      fieldErrors.phone
                        ? "border-red-300 dark:border-red-700"
                        : "border-gray-300 dark:border-gray-700"
                    }`}
              ...
              <div>
                <div className="flex items-stretch">
                  ...
                  <button
                    ...
                    className={`inline-flex items-center px-3 h-12 border border-l-0 rounded-r-md bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 ${
                      fieldErrors.password
                        ? "border-red-300 dark:border-red-700"
                        : "border-gray-300 dark:border-gray-700"
                    }`}
