...
export class ApiDiagnostic {
  private static readonly API_URL = process.env.NEXT_PUBLIC_API_URL || "https://x1xv-egpg-1mua.b2.xano.io/api:SzJNIj2V";
  private static readonly AUTH_URL = process.env.NEXT_PUBLIC_AUTH_URL || "https://x1xv-egpg-1mua.b2.xano.io/api:SzJNIj2V";
